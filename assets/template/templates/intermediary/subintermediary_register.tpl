...
<div class="center_home_content">
                        <div class="contact-form">
                             ...
                             <form class="login-form" method="POST" action ="{$site_url}/intermediary/save_subintermediary" id="register_subintermediary" enctype="multipart/form-data">
                                <div class="row">
                                 ...
                                 <div class="search-tab-content" style="">
                                    ...
                                    <div class="tab-pane fade active in" id="flights-tab">
                                          ...
                                          <div class="title-container">
                                             <h2 class="search-title">Sub Travel Agent</h2>
                                         ...
                                         <div class="search-content">
                                             ...
                                             <div class="row">
                                                <div class="col-md-6">
                                                   ...
                                                   <input type="text" class="input-text full-width departure_id" name="company_name" id="company_name"/>
                                                   <span id="company_name_ch"></span>
                                                </div>
                                                <div class="col-md-6">
                                                   <label>Nama Legal</label>
                                                    <input type="text" class="input-text full-width destination_id" name="legal_name" id="legal_name"/>
                                             ...
                                             <div class="row">
                                                <div class="col-md-6">
                                                   ...
                                                   <input type="text" class="input-text full-width departure_id" id="company_phone" name="company_phone"/>
                                                   <span id="company_phone_ch"></span>
                                                </div>
                                                <div class="col-md-6">
                                                   <label>Nomor Fax</label>
                                                    <input type="text" class="input-text full-width destination_id" name="company_fax_number" id="company_fax_number"/>
                                             ...
                                             <div class="row">
                                                <div class="col-md-6">
                                                   <label>Website</label>
                                                   <input type="text" class="input-text full-width departure_id" name="company_web" id="company_web"/>
                                                </div>
                                                <div class="col-md-6">
                                                   <label>Alamat Email</label>
                                                    <input type="text" class="input-text full-width destination_id" id="email_office" name="email_office"/>
                                             ...
                                             <div class="row">
                                                <div class="col-md-12">
                                                   ...
                                                   <input type="text" class="input-text full-width departure_id" name="company_bank_name" id="company_bank_name"/>
                                              ...
                                              <div class="row">
                                                <div class="col-md-12">
                                                   ...
                                                   <input type="text" class="input-text full-width departure_id" name="account_number" id="account_number"/><span id="account_number_ch"></span>
                                                </div>
                                             </div>
                                              <div class="row">
                                                <div class="col-md-12">
                                                   <label>Nama Pemegang Akun</label>
                                                   <input type="text" class="input-text full-width departure_id" id="account_name" name="account_name" id="account_name"/>
                                             ...
                                             <hr>
                                             <h5 class="title">Informasi Agen Penjualan</h5>
                                             <!-- <label>Mulai</label> -->
                                             <div class="row">
                                                <div class="col-md-6">
                                                   <label>Email</label>
                                                   <!-- <div class="datepicker-wrap-order"> -->
                                                      <input type="text" id="email_agent" name="email_agent" class="input-text full-width"/>
                                                ...
                                                <div class="col-md-6">
                                                   ...
                                                   <!-- <div class="datepicker-wrap-order"> -->
                                                      <input type="password" name="password_agent" id="password_agent" class="input-text full-width"/>
                                             ...
                                             <div class="row">
                                                <div class="col-md-12">
                                                   ...
                                                   <!-- <div class="datepicker-wrap-order"> -->
                                                      <input type="text" id="fullname_agent" name="fullname_agent" class="input-text full-width"/>
                                             ...
                                             <div class="row">
                                                <div class="col-md-6">
                                                   ...
                                                   <!-- <div class="datepicker-wrap-order"> -->
                                                      <input type="text" id="phone_number_agent" name="phone_number_agent"  class="input-text full-width"/>
                                                   <!-- </div> -->
                                                ...
                                                <div class="col-md-6">
                                                   <label>No Telepon</label>
                                                   <!-- <div class="datepicker-wrap-order"> -->
                                                      <input type="text" name="phone_number_agent1" id="phone_number_agent1" class="input-text full-width"/>
                                                   <!-- </div> -->
                                              ...
                                              <div class="row">
                                                <div class="col-md-12">
                                                   <label>Alamat</label>
                                                   <textarea style="width: 100%;" name="intermediary_agent_address" id="address_agent"></textarea>
                                             ...
                                             <div class="row">
                                                <div class="col-md-6">
                                                   ...
                                                   <div class="datepicker-wrap-order">
                                                      <input type="text" name="birthdate_agent" id="birthdate_agent" class="input-text full-width"/>
                                                ...
                                                <div class="col-md-6">
                                                   <label>No KTP</label>
                                                   <!-- <div class="datepicker-wrap-order"> -->
                                                      <input type="text" name="identity_no_agent" id="identity_no_agent" class="input-text full-width"/>
...
jQuery(document).ready(function($){
  ...
  $('#register_subintermediary').on('keyup keypress', function(e) {
  ...
  $('#register_subintermediary').submit(function(e) {
      e.preventDefault(); 
      ...
      if(field_check()){
        x.className = "show";
        $.ajax({
            url:"{$site_url}/intermediary/save_subintermediary",
            type:"post",
  ...
  function field_check(){
      ...
      var company_fax_number_ch = validateInputText('#company_fax_number','#company_fax_number');
