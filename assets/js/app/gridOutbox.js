...
var smgridOutbox = Ext.create('Ext.selection.CheckboxModel', {
    allowDeselect: true,
    mode: 'MULTI',
    listeners: {
        deselect: function(model, record, index) {
            var selectedLen = smgridOutbox.getSelection().length;
...
// Ext.create(dir_sys+'.assets.js.app.gridOutbox');

var gridOutbox = Ext.create('Ext.grid.Panel', {
// Ext.define('gridOutbox', {
    // title: 'Jenis Simpanan',
    // itemId: 'gridOutbox',
    id: 'gridOutbox',
    // extend: 'Ext.grid.Panel',
    // alias: 'widget.gridOutbox',
    id:'gridOutbox',
    title: 'Pesan Keluar',
    store: storeGridOutbox,
    selModel: smgridOutbox,
    loadMask: true,
    columns: [{
            header: 'message_id',
            dataIndex: 'status',
